...
class CarSimFMI():
    ...
    def _ininitialize(self):
        ...
        # try:
        #     self.fmu = fmpy.instantiate_fmu(unzipdir, self.model_description, fmi_type=fmi_type)
        # except Exception as e:
        #     raise Exception(f"Failed to instantiate FMU: {e}")
    ...
    def simulate(self, vrs_output_indicies):
        self.fmu.doStep(currentCommunicationPoint=self.current_time,
